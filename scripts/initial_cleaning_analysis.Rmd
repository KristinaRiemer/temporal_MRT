...
```
Download Berkeley Earth temperature data if it isn't already. 
```{r}
...
* What's the baseline/reference for the anomaly? 
    * "Anomalies relative to 1951-1980 mean", from "Video of Temperature Field" on main data page
    * Where to get this mean from? 
