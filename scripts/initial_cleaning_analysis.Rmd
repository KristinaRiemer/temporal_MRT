...
#### TODO 
* Add in if statement to prevent downloading and unzipping coordinates file every time
...
portal_mean_latlon = spTransform(portal_mean_UTM, CRS("+proj=longlat +datum=WGS84"))
```
