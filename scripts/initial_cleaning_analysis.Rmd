...
* Combine mass-temp data (i.e., site_annual_masses) for all sites into single 
dataframe, then separate plotting of that? 
...
for(each_site in sites){
  ...
  print(ggplot(site_annual_masses, aes(x = avg_temp, y = mass_mean)) +
    geom_point() +
