---
title: "Exploration of Datasets for Temporal MRT Project"
...
* Create test for reasonable temp range for Florida
...
* Lat and lon are center of grid box; need to find closest one for each site
...
* What's the baseline for the anomaly? 
...
```
Temperature file has `r temp$nvars` variables, `r temp$ndims` dimensions and 
`r temp$natts` NetCDF attributes. 
